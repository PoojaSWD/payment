...
if(!paymentDetails.amount || !paymentDetails.customerId || !paymentDetails.customerEmail || !paymentDetails.customerPhone || !paymentDetails.customerhotel) {
    ...
    params['CALLBACK_URL'] ='https://zomclonpay.herokuapp.com/callback';
     ...
     checksum_lib.genchecksum(params, config.PaytmConfig.key, function (err, checksum) {
       ...
       var post_req = https.request(options, function(post_res) {
         ...
         post_res.on('end', function(){
           ...
           res.redirect(`https://zomclone.netlify.app/viewBooking?status=${_results.STATUS}&ORDERID=${_results.ORDERID}&date=${_results.TXNDATE}&bank=${_results.BANKNAME}`)
           });
       });
